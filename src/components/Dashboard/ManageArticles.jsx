...
//     queryKey: ["all-articles", page],
//     queryFn: async () => {
//       const res = await axiosInstance.get(`/articles?page=${page}&limit=${limit}`);
//       return res.data;
//     },
//     keepPreviousData: true,
//   });
...
//   if (isError) return <p className="text-center text-red-500 py-10">Failed to load articles.</p>;
...
//                 {articles.map((article, index) => (
//                   <tr key={article._id}>
//                     <td className="px-4 py-2 border text-center">{(page - 1) * limit + index + 1}</td>
//                     <td className="px-4 py-2 border">{article.title}</td>
//                     <td className="px-4 py-2 border text-center">{article.category}</td>
//                     <td className="px-4 py-2 border text-center">{article.status}</td>
